...
define("EW_PROJECT_ID", "{7f469210-0e17-43e2-b956-594c3d118e1f}", TRUE); // Project ID (GUID)
$EW_RELATED_PROJECT_ID = "";
$EW_RELATED_LANGUAGE_FOLDER = "";
define("EW_RANDOM_KEY", 'Z1JrStjz7pb72skA', TRUE); // Random key for encryption
...
$EW_CONN["DB"] = array("conn" => NULL, "id" => "DB", "type" => "MYSQL", "host" => "localhost", "port" => 3306, "user" => "root", "pass" => "", "db" => "taman_jompie", "qs" => "`", "qe" => "`");
